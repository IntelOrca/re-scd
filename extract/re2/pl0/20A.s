...
.proc main_00
    if                      0, off_097C
    ck                      1, 6, 1
    sce_em_set              0, 0, ENEMY_ZOMBIERANDOM, 0, 0, 0, 3, 0, 97, -14125, 0, -16898, 3217, 0, 0
    sce_em_set              0, 1, ENEMY_ZOMBIERANDOM, 6, 0, 0, 4, 0, 98, -15875, 0, -3353, 909, 0, 0
    sce_em_set              0, 2, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 99, -14403, 0, -3485, 5055, 0, 0
    sce_em_set              0, 3, ENEMY_ZOMBIERANDOM, 6, 0, 0, 4, 0, 100, -16576, 0, -10470, 56, 0, 0
    sce_em_set              0, 4, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 101, -15486, 0, -17526, 3533, 0, 0
    sce_em_set              0, 5, ENEMY_ZOMBIERANDOM, 6, 0, 0, 4, 0, 102, -13121, 0, -15298, 2749, 0, 0
    evt_end                 0
    endif
    nop
...
off_0996:
    ...
    if                      0, off_0AC6
    ck                      1, 1, 0
    sce_em_set              0, 0, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 32, -15699, 0, 3739, 917, 0, 0
    sce_em_set              0, 1, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 33, -15925, 0, -1600, 933, 0, 0
    sce_em_set              0, 2, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 34, -10742, 0, 153, 2039, 0, 0
    sce_em_set              0, 3, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 124, -14750, 0, 1102, 963, 0, 0
    sce_em_set              0, 4, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 205, -13611, 0, -1017, 1117, 0, 0
    sce_em_set              0, 5, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 206, -11383, 0, 2914, 1349, 0, 0
    else                    0, off_0B4C

off_0AC6:
    sce_em_set              0, 0, ENEMY_ZOMBIERANDOM, 0, 0, 0, 3, 0, 32, -10745, 0, -698, 3055, 0, 0
    sce_em_set              0, 1, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 33, -15888, 0, -6064, 833, 0, 0
    sce_em_set              0, 2, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 34, -13749, 0, -3100, 1231, 0, 0
    sce_em_set              0, 3, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 124, -15220, 0, -12036, 328, 0, 0
    sce_em_set              0, 4, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 205, -13610, 0, -17095, 2551, 0, 0
    sce_em_set              0, 5, ENEMY_ZOMBIERANDOM, 6, 0, 0, 3, 0, 206, -13734, 0, -5971, 1544, 0, 0
    nop
    nop
