...
off_12D0:
    ...
    sce_em_set              0, 255, ENEMY_ADA_WONG_1, 0, 64, 0, 0, 0, 255, -1269, -1800, -7849, 392, 0, 0
    sce_em_set              0, 0, ENEMY_LEON_KENNEDY_BANDAGED, 0, 0, 1, 0, 0, 255, 20000, 20000, 20000, -3496, 0, 0
    if                      0, off_132A
    ck                      FG_GAME, F_SCENARIO, 1
    ck                      FG_LOCK, 3, 1
    if                      0, off_1328
...
off_1346:
    ...
    sce_em_set              0, 255, ENEMY_ADA_WONG_1, 0, 4, 1, 31, 0, 255, -1040, -1800, -7058, -3496, 0, 0
    else                    0, off_138A

off_1372:
    sce_em_set              0, 255, ENEMY_ADA_WONG_1, 0, 4, 0, 31, 0, 255, 5172, 0, -21308, -1216, 0, 0
    nop
    nop
