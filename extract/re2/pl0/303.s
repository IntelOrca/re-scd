...
.proc main_09
    if                      0, off_1BA2
    ck                      FG_SCENARIO, 101, 1
    if                      0, off_1BA0
    ck                      FG_SCENARIO, 102, 1
    if                      0, off_1B9E
    ck                      FG_SCENARIO, 103, 1
    if                      0, off_1B9C
    ck                      FG_SCENARIO, 104, 1
    if                      0, off_1B9A
    ck                      FG_COMMON, 58, 0
