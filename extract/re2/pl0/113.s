...
off_0F9C:
    if                      0, off_1018
    ck                      4, 15, 0
    sce_em_set              0, 0, ENEMY_CLAIREREDFIELD, 0, 64, 0, 0, 0, 255, 26153, 0, 18710, -4792, 0, 0
    set                     4, 255, 1
    if                      0, off_0FEA
    cmp                     0, 26, CMP_EQ, 0
    sce_em_set              0, 1, ENEMY_SHERRYWITHPENDANT, 0, 72, 0, 0, 0, 255, -22552, 0, -18627, 1419, 0, 0
    set                     5, 2, 1
    evt_exec                255, I_GOSUB, main_02
    else                    0, off_1002

off_0FEA:
    sce_em_set              0, 1, ENEMY_SHERRYWITHPENDANT, 0, 72, 0, 0, 0, 255, -24293, 0, -19696, -1973, 0, 0
    nop
    nop
