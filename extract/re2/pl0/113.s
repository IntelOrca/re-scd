...
off_0E18:
    item_aot_set            ID_AOT_4, SCE_ITEM, SAT_PL | SAT_MANUAL | SAT_FRONT, 0, 0, 0, 0, 10, 10, ITEM_HANDGUNPARTS, 1, 18, ID_OBJ_1, IF_DEFAULT
    obj_model_set           ID_OBJ_1, 0, 0, 0, 0, 0, 0, 10, 48, -14415, -300, -18553, 0, -2880, 0, 0, 0, 0, 0, 0, 0, 0, 0
    if                      0, off_0EE6
    ...
    obj_model_set           ID_OBJ_2, 0, 0, 0, 0, 0, 0, 10, 16, -27504, -2550, -3743, 0, 832, 0, 0, 0, 0, 0, 0, 0, 0, 0
    else                    0, off_0EE2

off_0EA4:
    item_aot_set            ID_AOT_5, SCE_ITEM, SAT_PL | SAT_MANUAL | SAT_FRONT, 0, 0, -27854, -4717, 1210, 1450, ITEM_SHOTGUNAMMO, 7, 145, ID_OBJ_3, IF_DEFAULT
    obj_model_set           ID_OBJ_3, 0, 0, 0, 0, 0, 0, 10, 16, -27504, -2550, -3743, 0, 832, 0, 0, 0, 0, 0, 0, 0, 0, 0
    nop
    nop
...
off_0F08:
    item_aot_set            ID_AOT_5, SCE_ITEM, SAT_PL | SAT_MANUAL | SAT_FRONT, 0, 0, -27854, -4717, 1210, 1450, ITEM_SHOTGUNAMMO, 7, 145, ID_OBJ_255, IF_FLOOR
    nop
    nop
...
off_0F22:
    ...
    item_aot_set            ID_AOT_2, SCE_ITEM, SAT_PL | SAT_MANUAL | SAT_FRONT, 0, 0, -26274, -1287, 1320, 1790, ITEM_DIAMONDKEY, 2, 30, ID_OBJ_4, IF_GLINT_RED | IF_FLOOR
    obj_model_set           ID_OBJ_4, 0, 0, 0, 0, 0, 0, 10, 16, -25504, 0, 57, 128, 2496, 0, 0, 0, 0, 0, 0, 0, 0, 0
    if                      0, off_0F7C
    ck                      FG_COMMON, 15, 0
...
off_0F9C:
    if                      0, off_1018
    ck                      FG_COMMON, 15, 0
    sce_em_set              0, ID_EM_0, ENEMY_CLAIRE_REDFIELD, 0, AI_40, 0, SBK_0, 0, 255, 26153, 0, 18710, -4792, 0, 0
    set                     FG_COMMON, 255, 1
    if                      0, off_0FEA
    cmp                     0, V_CUT, CMP_EQ, 0
    sce_em_set              0, ID_EM_1, ENEMY_SHERRY_PENDANT, 0, AI_08 | AI_40, 0, SBK_0, 0, 255, -22552, 0, -18627, 1419, 0, 0
    set                     FG_ROOM, 2, 1
    evt_exec                255, I_GOSUB, main_02
    else                    0, off_1002

off_0FEA:
    sce_em_set              0, ID_EM_1, ENEMY_SHERRY_PENDANT, 0, AI_08 | AI_40, 0, SBK_0, 0, 255, -24293, 0, -19696, -1973, 0, 0
    nop
    nop

off_1002:
    aot_set                 ID_AOT_14, SCE_EVENT, SAT_PL | SAT_MANUAL | SAT_FRONT, 0, 0, -25654, -20360, 1320, 1270, 255, 0, I_GOSUB, main_04, 0, 0
    endif
    nop
...
.proc main_05
    ...
    aot_set                 ID_AOT_16, SCE_EVENT, SAT_PL | SAT_UNDER, 0, 0, -28694, -23970, 11900, 8740, 255, 0, I_GOSUB, main_06, 0, 0
    else                    0, off_12DC
...
.proc main_07
    ...
    aot_set                 ID_AOT_16, SCE_EVENT, SAT_PL | SAT_UNDER, 0, 0, -28694, -23970, 11900, 8740, 255, 0, I_GOSUB, main_08, 0, 0
    else                    0, off_1490
