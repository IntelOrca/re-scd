...
off_29A0:
    item_aot_set            11, SCE_ITEM, SAT_AUTO, 0, 0, 0, 0, 0, 0, ITEM_BISHOPPLUG, 1, 21, 5, 0
    obj_model_set           5, 0, 0, 0, 0, 0, 0, 10, 16, -21480, -2019, -10545, 0, 0, -256, 0, 0, 0, 0, 0, 0, 0, 0
    gosub                   2
    evt_end                 0
...
.proc main_08
    ...
    member_copy             16, 32
    nop
    calc                    0, OP_SUB, 16, 450
    member_set2             32, 16
    nop
    member_copy             16, 35
    nop
    calc                    0, OP_ADD, 16, 450
    member_set2             35, 16
    nop
    speed_set               2, -15
    for                     0, off_32DC, 30
