...
off_1FCE:
    ...
    sca_id_set              30, 0, 0
    if                      0, off_208E
    ck                      FG_GENERAL_1, 146, 1
    sca_id_set              11, 0, 0
    sca_id_set              22, 0, 152
    if                      0, off_2034
    ck                      FG_GENERAL_1, 147, 0
...
off_2164:
    ...
    if                      0, off_217C
    ck                      FG_GENERAL_1, 146, 0
    set                     FG_GENERAL_1, 146, 1
    else                    0, off_2186

off_217C:
    set                     FG_GENERAL_1, 146, 0
    set                     FG_GENERAL_1, 147, 0
    nop
    nop
