...
.proc main
    ...
    sce_em_set              0, 255, ENEMY_SHERRY_PENDANT, 0, 0, 31, 32, 0, 255, 7770, -1800, -12642, 3072, 0, 0
    sce_em_set              0, 0, ENEMY_BIRKIN_1, 5, 64, 31, 0, 0, 255, 20000, 20000, 20000, 2720, 0, 0
...
off_128C:
    ...
    sce_em_set              0, 255, ENEMY_SHERRY_PENDANT, 0, 4, 1, 32, 0, 255, -1040, -1800, -7058, -3496, 0, 0
    else                    0, off_12D0

off_12B8:
    sce_em_set              0, 255, ENEMY_SHERRY_PENDANT, 0, 4, 0, 32, 0, 255, 5172, 0, -21308, -1216, 0, 0
    nop
    nop
...
off_1500:
    ...
    set                     FG_GENERAL_2, 30, 1
    else                    0, off_1522

off_1510:
    set                     FG_GENERAL_2, 30, 0
    se_on                   2, 266, 3, 0, 0, 0
    nop
    nop
