...
off_2550:
    if                      0, off_25B8
    ck                      FG_GENERAL_1, 51, 0
    ck                      FG_GENERAL_2, 31, 1
    if                      0, off_257E
    ck                      FG_GAME, F_PLAYER, 0
    sce_em_set              0, 255, ENEMY_ADA_WONG_1, 0, 8, 0, 0, 0, 0, -261, -1800, -7703, -3264, 0, 0
    else                    0, off_25A0

off_257E:
    if                      0, off_259E
    ck                      FG_GAME, F_SCENARIO, 0
    sce_em_set              0, 255, ENEMY_SHERRY_PENDANT, 0, 0, 0, 0, 0, 0, 7770, -1800, -12642, 3072, 0, 0
    endif
    nop
...
.proc main
    ...
    sce_em_set              0, 255, ENEMY_SHERRY_PENDANT, 0, 4, 1, 32, 0, 255, -8829, -1800, 417, 1904, 0, 0
    else                    0, off_2644

off_262C:
    sce_em_set              0, 255, ENEMY_SHERRY_PENDANT, 0, 4, 1, 32, 0, 255, 5556, -1800, -22220, -2921, 0, 0
    nop
    nop
...
off_3236:
    if                      0, off_3248
    ck                      FG_GENERAL_2, 30, 1
    set                     FG_GENERAL_1, 156, 1
    set                     FG_GENERAL_1, 155, 0
    endif
    nop
