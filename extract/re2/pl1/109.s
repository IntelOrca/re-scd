...
.proc main_02
    ...
    if                      0, off_21D8
    ck                      FG_COMMON, 49, 0
    aot_set                 ID_AOT_6, SCE_EVENT, SAT_PL | SAT_UNDER, 0, 0, -8263, -15571, 2100, 5500, 255, 0, I_GOSUB, main_0E, 0, 0
    gosub                   main_08
    set                     FG_ROOM, 3, 1
    gosub                   main_10
    else                    0, off_21DE
...
off_21E2:
    ...
    if                      0, off_2212
    ck                      FG_COMMON, 50, 0
    aot_set                 ID_AOT_7, SCE_EVENT, SAT_PL | SAT_UNDER, 0, 0, -17467, -17777, 5480, 1958, 255, 0, I_GOSUB, main_0C, 0, 0
    set                     FG_ROOM, 8, 1
    gosub                   main_06
    gosub                   main_0F
    else                    0, off_2218
...
off_2230:
    aot_set                 ID_AOT_10, SCE_AUTO, SAT_PL | SAT_UNDER, 0, 0, -6022, -2438, 1850, 2800, 255, 0, 24, 22, 0, 0
    if                      0, off_22C2
    ck                      FG_ENEMY, 105, 0
    sce_em_set              0, ID_EM_0, ENEMY_TYRANT_1, 0, AI_08 | AI_INACTIVE, 0, SBK_18, 0, 105, -15025, 0, -21383, -904, 0, 0
    aot_reset               ID_AOT_1, SCE_EVENT, SAT_PL | SAT_MANUAL | SAT_FRONT, 255, 0, I_GOSUB, main_12, 0, 0
    aot_reset               ID_AOT_2, SCE_EVENT, SAT_PL | SAT_MANUAL | SAT_FRONT, 255, 0, I_GOSUB, main_13, 0, 0
    ...
    aot_set                 ID_AOT_9, SCE_EVENT, SAT_PL | SAT_UNDER, 0, 0, -4396, -3958, 2400, 4900, 255, 0, I_GOSUB, main_16, 0, 0
    gosub                   main_21
...
off_22C2:
    ...
    aot_reset               ID_AOT_10, SCE_EVENT, SAT_PL | SAT_MANUAL | SAT_FRONT, 255, 0, I_GOSUB, main_11, 0, 0
    gosub                   main_0F
    if                      0, off_2322
    ck                      FG_COMMON, 185, 1
...
off_2328:
    aot_set                 ID_AOT_8, SCE_EVENT, SAT_PL | SAT_MANUAL | SAT_FRONT, 0, 0, -15263, -20271, 1800, 3600, 255, 0, I_GOSUB, main_15, 0, 0
