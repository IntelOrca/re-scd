...
.proc main_09
    ...
    sce_em_set              0, 255, ENEMY_SHERRY_JACKET, 0, 0, 0, 0, 0, 255, -15770, 0, -15778, 221, 272, 0
    ...
    nop
    sce_em_set              0, 1, ENEMY_ANNETTEBIRKIN_1, 0, 9, 0, 0, 0, 255, -14243, 900, -15928, 3691, 271, 20
    work_set                WK_ENEMY, 1
    nop
    member_copy             V_TEMP, 0
    nop
...
off_2C18:
    sce_em_set              0, 1, ENEMY_ANNETTEBIRKIN_1, 0, 9, 0, 0, 0, 255, -14243, 900, -15928, 3691, 257, 0
    work_set                WK_ENEMY, 1
    nop
    member_copy             V_TEMP, 0
    nop
...
.proc main_12
    if                      0, off_2F30
    ck                      FG_GAME, 3, 1
    sce_em_set              0, 255, ENEMY_SHERRY_JACKET, 0, 4, 0, 0, 0, 255, -7908, 0, 7511, -2949, 0, 0
    endif
    nop
...
.proc main_13
    if                      0, off_2F5E
    ck                      FG_GENERAL_1, 176, 0
    if                      0, off_2F5C
    ck                      34, 29, 1
    set                     FG_GENERAL_1, 176, 1
    work_set                WK_ENEMY, 255
    nop
    member_copy             V_TEMP, 0
    nop
